...
class ReportXlsxAbstract(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        _logger.warning("second generate")
    ...
    def _define_formats(self, workbook):
        ...
        res['format_ws_title']= workbook.add_format({"bold": True, "font_size": 14})

        # no border formats
        res['format_left'] = workbook.add_format({"align": "left"})
        res['format_center'] = workbook.add_format({"align": "center"})
        res['format_right'] = workbook.add_format({"align": "right"})
        res['format_amount_left'] = workbook.add_format(
            {"align": "left", "num_format": num_format}
        )
        res['format_amount_center'] = workbook.add_format(
            {"align": "center", "num_format": num_format}
        )
        res['format_amount_right'] = workbook.add_format(
            {"align": "right", "num_format": num_format}
        )
        res['format_amount_conditional_left'] = workbook.add_format(
            {"align": "left", "num_format": num_format_conditional}
        )
        res['format_amount_conditional_center'] = workbook.add_format(
            {"align": "center", "num_format": num_format_conditional}
        )
        res['format_amount_conditional_right'] = workbook.add_format(
            {"align": "right", "num_format": num_format_conditional}
        )
        res['format_percent_left'] = workbook.add_format(
            {"align": "left", "num_format": pct_format}
        )
        res['format_percent_center'] = workbook.add_format(
            {"align": "center", "num_format": pct_format}
        )
        res['format_percent_right'] = workbook.add_format(
            {"align": "right", "num_format": pct_format}
        )
        res['format_percent_conditional_left'] = workbook.add_format(
            {"align": "left", "num_format": pct_format_conditional}
        )
        res['format_percent_conditional_center'] = workbook.add_format(
            {"align": "center", "num_format": pct_format_conditional}
        )
        res['format_percent_conditional_right'] = workbook.add_format(
            {"align": "right", "num_format": pct_format_conditional}
        )
        res['format_integer_left'] = workbook.add_format(
            {"align": "left", "num_format": int_format}
        )
        res['format_integer_center'] = workbook.add_format(
            {"align": "center", "num_format": int_format}
        )
        res['format_integer_right'] = workbook.add_format(
            {"align": "right", "num_format": int_format}
        )
        res['format_integer_conditional_left'] = workbook.add_format(
            {"align": "right", "num_format": int_format_conditional}
        )
        res['format_integer_conditional_center'] = workbook.add_format(
            {"align": "center", "num_format": int_format_conditional}
        )
        res['format_integer_conditional_right'] = workbook.add_format(
            {"align": "right", "num_format": int_format_conditional}
        )
        res['format_date_left'] = workbook.add_format(
            {"align": "left", "num_format": date_format}
        )
        res['format_date_center'] = workbook.add_format(
            {"align": "center", "num_format": date_format}
        )
        res['format_date_right'] = workbook.add_format(
            {"align": "right", "num_format": date_format}
        )

        res['format_left_bold'] = workbook.add_format({"align": "left", "bold": True})
        res['format_center_bold'] = workbook.add_format({"align": "center", "bold": True})
        res['format_right_bold'] = workbook.add_format({"align": "right", "bold": True})
        res['format_amount_left_bold'] = workbook.add_format(
            {"align": "left", "bold": True, "num_format": num_format}
        )
        res['format_amount_center_bold'] = workbook.add_format(
            {"align": "center", "bold": True, "num_format": num_format}
        )
        res['format_amount_right_bold'] = workbook.add_format(
            {"align": "right", "bold": True, "num_format": num_format}
        )
        res['format_amount_conditional_left_bold'] = workbook.add_format(
            {"align": "left", "bold": True, "num_format": num_format_conditional}
        )
        res['format_amount_conditional_center_bold'] = workbook.add_format(
            {"align": "center", "bold": True, "num_format": num_format_conditional}
        )
        res['format_amount_conditional_right_bold'] = workbook.add_format(
            {"align": "right", "bold": True, "num_format": num_format_conditional}
        )
        res['format_percent_left_bold'] = workbook.add_format(
            {"align": "left", "bold": True, "num_format": pct_format}
        )
        res['format_percent_center_bold'] = workbook.add_format(
            {"align": "center", "bold": True, "num_format": pct_format}
        )
        res['format_percent_right_bold'] = workbook.add_format(
            {"align": "right", "bold": True, "num_format": pct_format}
        )
        res['format_percent_conditional_left_bold'] = workbook.add_format(
            {"align": "left", "bold": True, "num_format": pct_format_conditional}
        )
        res['format_percent_conditional_center_bold'] = workbook.add_format(
            {"align": "center", "bold": True, "num_format": pct_format_conditional}
        )
        res['format_percent_conditional_right_bold'] = workbook.add_format(
            {"align": "right", "bold": True, "num_format": pct_format_conditional}
        )
        res['format_integer_left_bold'] = workbook.add_format(
            {"align": "left", "bold": True, "num_format": int_format}
        )
        res['format_integer_center_bold'] = workbook.add_format(
            {"align": "center", "bold": True, "num_format": int_format}
        )
        res['format_integer_right_bold'] = workbook.add_format(
            {"align": "right", "bold": True, "num_format": int_format}
        )
        res['format_integer_conditional_left_bold'] = workbook.add_format(
            {"align": "left", "bold": True, "num_format": int_format_conditional}
        )
        res['format_integer_conditional_center_bold'] = workbook.add_format(
            {"align": "center", "bold": True, "num_format": int_format_conditional}
        )
        res['format_integer_conditional_right_bold'] = workbook.add_format(
            {"align": "right", "bold": True, "num_format": int_format_conditional}
        )
        res['format_date_left_bold'] = workbook.add_format(
            {"align": "left", "bold": True, "num_format": date_format}
        )
        res['format_date_center_bold'] = workbook.add_format(
            {"align": "center", "bold": True, "num_format": date_format}
        )
        res['format_date_right_bold'] = workbook.add_format(
            {"align": "right", "bold": True, "num_format": date_format}
        )

        # # formats for worksheet table column headers
        res['format_theader_yellow_left'] = workbook.add_format(theader_yellow)
        res['format_theader_yellow_center'] = workbook.add_format(
            dict(theader_yellow, align="center")
        )
        res['format_theader_yellow_right'] = workbook.add_format(
            dict(theader_yellow, align="right")
        )
        res['format_theader_yellow_amount_left'] = workbook.add_format(
            dict(theader_yellow, num_format=num_format, align="left")
        )
        res['format_theader_yellow_amount_center'] = workbook.add_format(
            dict(theader_yellow, num_format=num_format, align="center")
        )
        res['format_theader_yellow_amount_right'] = workbook.add_format(
            dict(theader_yellow, num_format=num_format, align="right")
        )

        res['format_theader_yellow_amount_conditional_left'] = workbook.add_format(
            dict(theader_yellow, num_format=num_format_conditional, align="left")
        )
        res['format_theader_yellow_amount_conditional_center'] = workbook.add_format(
            dict(theader_yellow, num_format=num_format_conditional, align="center")
        )
        res['format_theader_yellow_amount_conditional_right'] = workbook.add_format(
            dict(theader_yellow, num_format=num_format_conditional, align="right")
        )
        res['format_theader_yellow_percent_left'] = workbook.add_format(
            dict(theader_yellow, num_format=pct_format, align="left")
        )
        res['format_theader_yellow_percent_center'] = workbook.add_format(
            dict(theader_yellow, num_format=pct_format, align="center")
        )
        res['format_theader_yellow_percent_right'] = workbook.add_format(
            dict(theader_yellow, num_format=pct_format, align="right")
        )
        res['format_theader_yellow_percent_conditional_left'] = workbook.add_format(
            dict(theader_yellow, num_format=pct_format_conditional, align="left")
        )
        res['format_theader_yellow_percent_conditional_center'] = workbook.add_format(
            dict(theader_yellow, num_format=pct_format_conditional, align="center")
        )
        res['format_theader_yellow_percent_conditional_right'] = workbook.add_format(
            dict(theader_yellow, num_format=pct_format_conditional, align="right")
        )
        res['format_theader_yellow_integer_left'] = workbook.add_format(
            dict(theader_yellow, num_format=int_format, align="left")
        )
        res['format_theader_yellow_integer_center'] = workbook.add_format(
            dict(theader_yellow, num_format=int_format, align="center")
        )
        res['format_theader_yellow_integer_right'] = workbook.add_format(
            dict(theader_yellow, num_format=int_format, align="right")
        )
        res['format_theader_yellow_integer_conditional_left'] = workbook.add_format(
            dict(theader_yellow, num_format=int_format_conditional, align="left")
        )
        res['format_theader_yellow_integer_conditional_center'] = workbook.add_format(
            dict(theader_yellow, num_format=int_format_conditional, align="center")
        )
        res['format_theader_yellow_integer_conditional_right'] = workbook.add_format(
            dict(theader_yellow, num_format=int_format_conditional, align="right")
        )

        res['format_theader_blue_left'] = workbook.add_format(theader_blue)
        res['format_theader_blue_center'] = workbook.add_format(
            dict(theader_blue, align="center")
        )
        res['.format_theader_blue_right'] = workbook.add_format(
            dict(theader_blue, align="right")
        )
        res['.format_theader_blue_amount_left'] = workbook.add_format(
            dict(theader_blue, num_format=num_format, align="left")
        )
        res['.format_theader_blue_amount_center'] = workbook.add_format(
            dict(theader_blue, num_format=num_format, align="center")
        )
        res['format_theader_blue_amount_right'] = workbook.add_format(
            dict(theader_blue, num_format=num_format, align="right")
        )
        res['format_theader_blue_amount_conditional_left'] = workbook.add_format(
            dict(theader_blue, num_format=num_format_conditional, align="left")
        )
        res['format_theader_blue_amount_conditional_center'] = workbook.add_format(
            dict(theader_blue, num_format=num_format_conditional, align="center")
        )
        res['format_theader_blue_amount_conditional_right'] = workbook.add_format(
            dict(theader_blue, num_format=num_format_conditional, align="right")
        )
        res['format_theader_blue_percent_left'] = workbook.add_format(
            dict(theader_blue, num_format=pct_format, align="left")
        )
        res['format_theader_blue_percent_center'] = workbook.add_format(
            dict(theader_blue, num_format=pct_format, align="center")
        )
        res['format_theader_blue_percent_right'] = workbook.add_format(
            dict(theader_blue, num_format=pct_format, align="right")
        )
        res['format_theader_blue_percent_conditional_left'] = workbook.add_format(
            dict(theader_blue, num_format=pct_format_conditional, align="left")
        )
        res['format_theader_blue_percent_conditional_center'] = workbook.add_format(
            dict(theader_blue, num_format=pct_format_conditional, align="center")
        )
        res['format_theader_blue_percent_conditional_right'] = workbook.add_format(
            dict(theader_blue, num_format=pct_format_conditional, align="right")
        )
        res['format_theader_blue_integer_left'] = workbook.add_format(
            dict(theader_blue, num_format=int_format, align="left")
        )
        res['format_theader_blue_integer_center'] = workbook.add_format(
            dict(theader_blue, num_format=int_format, align="center")
        )
        res['format_theader_blue_integer_right'] = workbook.add_format(
            dict(theader_blue, num_format=int_format, align="right")
        )
        res['format_theader_blue_integer_conditional_left'] = workbook.add_format(
            dict(theader_blue, num_format=int_format_conditional, align="left")
        )
        res['format_theader_blue_integer_conditional_center'] = workbook.add_format(
            dict(theader_blue, num_format=int_format_conditional, align="center")
        )
        res['format_theader_blue_integer_conditional_right'] = workbook.add_format(
            dict(theader_blue, num_format=int_format_conditional, align="right")
        )

        # formats for worksheet table cells
        res['format_tcell_left'] = workbook.add_format(dict(border, align="left"))
        res['format_tcell_center'] = workbook.add_format(dict(border, align="center"))
        res['format_tcell_right'] = workbook.add_format(dict(border, align="right"))
        res['format_tcell_amount_left'] = workbook.add_format(
            dict(border, num_format=num_format, align="left")
        )
        res['format_tcell_amount_center'] = workbook.add_format(
            dict(border, num_format=num_format, align="center")
        )
        res['format_tcell_amount_right'] = workbook.add_format(
            dict(border, num_format=num_format, align="right")
        )
        res['format_tcell_amount_conditional_left'] = workbook.add_format(
            dict(border, num_format=num_format_conditional, align="left")
        )
        res['format_tcell_amount_conditional_center'] = workbook.add_format(
            dict(border, num_format=num_format_conditional, align="center")
        )
        res['format_tcell_amount_conditional_right'] = workbook.add_format(
            dict(border, num_format=num_format_conditional, align="right")
        )
        res['format_tcell_percent_left'] = workbook.add_format(
            dict(border, num_format=pct_format, align="left")
        )
        res['format_tcell_percent_center'] = workbook.add_format(
            dict(border, num_format=pct_format, align="center")
        )
        res['format_tcell_percent_right'] = workbook.add_format(
            dict(border, num_format=pct_format, align="right")
        )
        res['format_tcell_percent_conditional_left'] = workbook.add_format(
            dict(border, num_format=pct_format_conditional, align="left")
        )
        res['format_tcell_percent_conditional_center'] = workbook.add_format(
            dict(border, num_format=pct_format_conditional, align="center")
        )
        res['format_tcell_percent_conditional_right'] = workbook.add_format(
            dict(border, num_format=pct_format_conditional, align="right")
        )
        res['format_tcell_integer_left'] = workbook.add_format(
            dict(border, num_format=int_format, align="left")
        )
        res['format_tcell_integer_center'] = workbook.add_format(
            dict(border, num_format=int_format, align="center")
        )
        res['format_tcell_integer_right'] = workbook.add_format(
            dict(border, num_format=int_format, align="right")
        )
        res['format_tcell_integer_conditional_left'] = workbook.add_format(
            dict(border, num_format=int_format_conditional, align="left")
        )
        res['format_tcell_integer_conditional_center'] = workbook.add_format(
            dict(border, num_format=int_format_conditional, align="center")
        )
        res['format_tcell_integer_conditional_right'] = workbook.add_format(
            dict(border, num_format=int_format_conditional, align="right")
        )
        res['format_tcell_date_left'] = workbook.add_format(
            dict(border, num_format=date_format, align="left")
        )
        res['format_tcell_date_center'] = workbook.add_format(
            dict(border, num_format=date_format, align="center")
        )
        res['format_tcell_date_right'] = workbook.add_format(
            dict(border, num_format=date_format, align="right")
        )

        res['format_tcell_left_bold'] = workbook.add_format(
            dict(border, align="left", bold=True)
        )
        res['format_tcell_center_bold'] = workbook.add_format(
            dict(border, align="center", bold=True)
        )
        res['format_tcell_right_bold'] = workbook.add_format(
            dict(border, align="right", bold=True)
        )
        res['format_tcell_amount_left_bold'] = workbook.add_format(
            dict(border, num_format=num_format, align="left", bold=True)
        )
        res['format_tcell_amount_center_bold'] = workbook.add_format(
            dict(border, num_format=num_format, align="center", bold=True)
        )
        res['format_tcell_amount_right_bold'] = workbook.add_format(
            dict(border, num_format=num_format, align="right", bold=True)
        )
        res['format_tcell_amount_conditional_left_bold'] = workbook.add_format(
            dict(border, num_format=num_format_conditional, align="left", bold=True)
        )
        res['format_tcell_amount_conditional_center_bold'] = workbook.add_format(
            dict(border, num_format=num_format_conditional, align="center", bold=True)
        )
        res['format_tcell_amount_conditional_right_bold'] = workbook.add_format(
            dict(border, num_format=num_format_conditional, align="right", bold=True)
        )
        res['format_tcell_percent_left_bold'] = workbook.add_format(
            dict(border, num_format=pct_format, align="left", bold=True)
        )
        res['format_tcell_percent_center_bold'] = workbook.add_format(
            dict(border, num_format=pct_format, align="center", bold=True)
        )
        res['format_tcell_percent_right_bold'] = workbook.add_format(
            dict(border, num_format=pct_format, align="right", bold=True)
        )
        res['format_tcell_percent_conditional_left_bold'] = workbook.add_format(
            dict(border, num_format=pct_format_conditional, align="left", bold=True)
        )
        res['format_tcell_percent_conditional_center_bold'] = workbook.add_format(
            dict(border, num_format=pct_format_conditional, align="center", bold=True)
        )
        res['format_tcell_percent_conditional_right_bold'] = workbook.add_format(
            dict(border, num_format=pct_format_conditional, align="right", bold=True)
        )
        res['format_tcell_integer_left_bold'] = workbook.add_format(
            dict(border, num_format=int_format, align="left", bold=True)
        )
        res['format_tcell_integer_center_bold'] = workbook.add_format(
            dict(border, num_format=int_format, align="center", bold=True)
        )
        res['format_tcell_integer_right_bold'] = workbook.add_format(
            dict(border, num_format=int_format, align="right", bold=True)
        )
        res['format_tcell_integer_conditional_left_bold'] = workbook.add_format(
            dict(border, num_format=int_format_conditional, align="left", bold=True)
        )
        res['format_tcell_integer_conditional_center_bold'] = workbook.add_format(
            dict(border, num_format=int_format_conditional, align="center", bold=True)
        )
        res['format_tcell_integer_conditional_right_bold'] = workbook.add_format(
            dict(border, num_format=int_format_conditional, align="right", bold=True)
        )
        res['format_tcell_date_left_bold'] = workbook.add_format(
            dict(border, num_format=date_format, align="left", bold=True)
        )
        res['format_tcell_date_center_bold'] = workbook.add_format(
            dict(border, num_format=date_format, align="center", bold=True)
        )
        res['format_tcell_date_right_bold'] = workbook.add_format(

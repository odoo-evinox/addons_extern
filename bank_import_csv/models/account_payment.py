...
class AccountPayment(models.Model):
    ...
    bank_tranzaction_uniqueid = fields.Text(readonly=1,help="if this is not null is the ank unique tranzaction id and must be unique")
...
# just tracking
    ...
    def from_javascript_open_form(self,*args):
        # def _api():
            # return "model"
        print('1331132')
        return {

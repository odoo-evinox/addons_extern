...
class AccountAccount(models.Model):
    ...
    def init(self, *a):
        """init called at every install to change the user_type_id for account
         408, 418. This is required to be able to create a invoice with a line
         with this accounts and a invoice with right base amount from
         sale and purchase
        """
